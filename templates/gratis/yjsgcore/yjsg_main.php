...
<body id="stylef<?php echo $default_font_family ?>" style="background:<?php echo $back_color; ?> url(<?php echo $this->baseurl ?>/templates/gratis/images/style1/body-bg<?php echo $back_image; ?>.png) fixed;">

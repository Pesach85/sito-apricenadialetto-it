...
REL_PATH = "administrator/templates/bluestork/css/template.css"
...
def main() -> int:
    ...
    try:
        ...
        if stat.S_ISREG(mode):
            backup_path = remote_path + ".bak_ui_" + datetime.now().strftime("%Y%m%d_%H%M%S")
    ...
    cmd = (
        f"php -l {posixpath.join(remote_root, 'administrator/index.php')}; "
